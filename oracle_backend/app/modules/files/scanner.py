...
def heuristic_polyglot_scan(file_path: str) -> dict:
    ...
    o discrepancias en los Magic Bytes.
    """
    ...
    # 1. Detección de firma PNG y chunk IEND (Fin de archivo legítimo)
        ...
        if iend_pos != -1:
            ...
            if expected_end_pos < len(content):
                ...
                report["details"].append(
                    ...
                    f"después del bloque IEND oficial de la imagen. Posible Webshell o script embebido."
                )

...
services:
  ...
  mcp-vector:
    ...
    volumes:
      - chroma_persistence:/app/chroma_data   # VOLUMEN NATIVO DE DOCKER
    networks:
      - mcp_secure_net
    restart: unless-stopped
...
volumes:
  chroma_persistence:   # DECLARACION DEL VOLUMEN NATIVO
"""
with open("infra/docker-compose.yml", "w", encoding="utf-8", newline="\n") as f:
    f.write(compose_code)

print("[+] Docker Compose regenerado usando volúmenes nativos para evitar choques de permisos en Windows.")